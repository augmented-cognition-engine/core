...
- [B1A governed action execution](b1a-governed-action-execution-candidate-v1.md) — candidate, merged; independent-adapter and released-artifact acceptance pending
...
- [B1C independent action adapter](b1c-independent-action-adapter-candidate-v1.md) — candidate; public review, merge, and released-artifact acceptance pending
