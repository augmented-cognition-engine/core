...
- [Intelligence OS 0.8.0 release closeout](evidence/intelligence-os-v0.8.0-release-closeout-v1.md)
  — the exact public tag, trusted workflow, artifact hashes, checkout-free installation, and
  milestone closure.
