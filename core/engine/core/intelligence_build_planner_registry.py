...
def register_intelligence_build_planner(
    *, profile_id: str, planner: IntelligenceBuildPlanner
    ...
    try:
        validate_intelligence_build_planner_registration(planner, profile_id=profile_id)
...
def resolve_intelligence_build_planner(profile_id: str) -> IntelligenceBuildPlanner | None:
