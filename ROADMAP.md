...
terminal resource reporting to direct and trusted-extension tasks. T1B remains a local candidate
pending public review and released-artifact closeout; it does not claim CPU or memory enforcement,
...
| T1 | not ready | Strengthen task recovery, replay, portability, cancellation, and resource reporting | [TP1 evidence](docs/evidence/state-engine-tp1-reliable-memory-lifecycle-v1.md) closes reliable observation claiming/recovery; [T1A candidate evidence](docs/evidence/t1a-durable-cancellation-candidate-v1.md) binds merged negotiated process-local cancellation; [T1B candidate evidence](docs/evidence/t1b-execution-limits-candidate-v1.md) adds local declared deadlines and terminal resource receipts; released-artifact closeout, portability, distributed recovery, broader resource enforcement, and topology guarantees remain |
