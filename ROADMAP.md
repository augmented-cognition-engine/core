...
| T1 | not ready | Strengthen task recovery, replay, portability, cancellation, and resource reporting | [TP1 evidence](docs/evidence/state-engine-tp1-reliable-memory-lifecycle-v1.md) closes reliable observation claiming/recovery; [T1A candidate evidence](docs/evidence/t1a-durable-cancellation-candidate-v1.md) binds merged negotiated process-local cancellation and awaits released-artifact closeout; portability, reporting, distributed recovery, and topology guarantees remain |
